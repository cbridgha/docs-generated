...
|+backchannelLogoutRequestTimeout+
...
|===
[#+oauthProvider/databaseStore/dataSource/identifyException+]*oauthProvider > databaseStore > dataSource > identifyException*
...
|+Specifies the back-channel logout URI for an OpenID Connect client.+
