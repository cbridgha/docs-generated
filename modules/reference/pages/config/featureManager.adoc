...
|+The platform specifies a programming model version, for example jakartaee-10. The platform version determines the version of for any enabled versionless features that are included in the specified platform.+
