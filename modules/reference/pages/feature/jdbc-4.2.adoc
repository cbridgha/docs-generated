...
include::./jdbc-4.2/description.adoc[opts=optional]
...
include::./jdbc-4.2/examples.adoc[opts=optional]
...
* xref:javadoc/api/jdbc-4.2.adoc[Java Database Connectivity 4.2]
// end::apis[]
// tag::requirements[]
// end::requirements[]
// tag::java-versions[]
