...
include::./appClientSupport-1.0/description.adoc[opts=optional]
...
include::./appClientSupport-1.0/examples.adoc[opts=optional]
...
* xref:javadoc/api/appClientSupport-1.0.adoc[Application Client Support for Server 1.0]
// end::apis[]
// tag::requirements[]
