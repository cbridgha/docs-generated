...
include::./opentracing-1.1/description.adoc[opts=optional]
...
include::./opentracing-1.1/examples.adoc[opts=optional]
...
* xref:javadoc/spi/opentracing-1.1.adoc[Opentracing 1.1]
// end::spi[]
