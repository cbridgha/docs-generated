...
include::./websocket-1.0/description.adoc[opts=optional]
...
include::./websocket-1.0/examples.adoc[opts=optional]
...
* xref:javadoc/api/websocket-1.0.adoc[Java WebSocket 1.0]
// end::apis[]
// tag::requirements[]
