...
include::./json/description.adoc[opts=optional]
include::./json-1.0/description.adoc[opts=optional]
...
include::./json/examples.adoc[opts=optional]
include::./json-1.0/examples.adoc[opts=optional]
