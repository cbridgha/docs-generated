...
include::./javaee/description.adoc[opts=optional]
include::./javaee-8.0/description.adoc[opts=optional]
...
include::./javaee/examples.adoc[opts=optional]
include::./javaee-8.0/examples.adoc[opts=optional]
