...
include::./opentracing-1.2/description.adoc[opts=optional]
...
include::./opentracing-1.2/examples.adoc[opts=optional]
...
* xref:javadoc/spi/opentracing-1.2.adoc[Opentracing 1.2]
// end::spi[]
