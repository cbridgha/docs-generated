...
include::./wasJmsServer/description.adoc[opts=optional]
include::./wasJmsServer-1.0/description.adoc[opts=optional]
...
include::./wasJmsServer/examples.adoc[opts=optional]
include::./wasJmsServer-1.0/examples.adoc[opts=optional]
...
* xref:javadoc/api/wasJmsServer-1.0.adoc[Message Server 1.0]
// end::apis[]
// tag::requirements[]
// end::requirements[]
// tag::java-versions[]
