...
include::./opentracing-1.3/description.adoc[opts=optional]
...
include::./opentracing-1.3/examples.adoc[opts=optional]
...
* xref:javadoc/spi/opentracing-1.3.adoc[Opentracing 1.3]
// end::spi[]
