...
include::./mpRestClient-1.4/description.adoc[opts=optional]

// tag::enable[]
== Enabling this feature
To enable the MicroProfile Rest Client 1.4 feature, add the following element declaration into your `server.xml` file, inside the `featureManager` element:
...
include::./mpRestClient-1.4/examples.adoc[opts=optional]
...
[source,]
----
com.ibm.websphere.appserver.mpRestClient-1.4; type="osgi.subsystem.feature"
----
// end::feature-require[]
// tag::spi[]
// end::spi[]
