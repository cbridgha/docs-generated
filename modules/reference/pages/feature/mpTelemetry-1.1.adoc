...
include::./mpTelemetry-1.1/description.adoc[opts=optional]

// tag::enable[]
== Enabling this feature
To enable the MicroProfile Telemetry 1.1 feature, add the following element declaration into your `server.xml` file, inside the `featureManager` element:
...
include::./mpTelemetry-1.1/examples.adoc[opts=optional]
...
[source,]
----
io.openliberty.mpTelemetry-1.1; type="osgi.subsystem.feature"
----
// end::feature-require[]
// tag::spi[]

== SPI packages provided by this feature
* xref:javadoc/spi/mpTelemetry-1.1.adoc[MicroProfile Telemetry 1.1]
// end::spi[]
