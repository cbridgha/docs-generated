...
include::./mpTelemetry-2.0/description.adoc[opts=optional]
...
include::./mpTelemetry-2.0/examples.adoc[opts=optional]
...
* xref:javadoc/spi/mpTelemetry-2.0.adoc[MicroProfile Telemetry 2.0]
// end::spi[]
